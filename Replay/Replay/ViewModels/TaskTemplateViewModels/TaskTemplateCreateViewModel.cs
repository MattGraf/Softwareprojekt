...
{
    /// <summary>
    /// ViewModel for the creation of a <see cref="TaskTemplate"/>
    ...
    public class TaskTemplateCreateViewModel
    {
        ...
        public void Initialize(DepartmentContainer departmentContainer)
        {
            ...
            ContractTypes[0] = new ContractTypeViewModel {
                Name = "Festanstellung",
                IsSelected = true
            };
            ContractTypes[1] = new ContractTypeViewModel {
                Name = "Werkstudent",
                IsSelected = true
            };
            ContractTypes[2] = new ContractTypeViewModel {
                Name = "Praktikum",
                IsSelected = true
            };
            ContractTypes[3] = new ContractTypeViewModel {
                Name = "Trainee",
                IsSelected = true
            };
