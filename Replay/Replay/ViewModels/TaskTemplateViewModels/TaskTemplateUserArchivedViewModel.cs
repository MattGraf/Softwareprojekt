...
{
    /// <summary>
    /// ViewModel for overview of the archived <see cref="TaskTemplate"/>s of the <see cref="Models.Account.User"/> who wants to see his list
    /// </summary>
    /// <author>Matthias Grafberger</author>
    public class TaskTemplateUserArchivedViewModel
    {
        ...
        /// <author>Matthias Grafberger</author>
        public void SetTaskTemplateUserArchivedViewModelListWithUser(User user, UserRolesContainer userRolesContainer, MakandraProcessRoleContainer makandraProcessRoleContainer, MakandraProcessContainer makandraProcessContainer, TaskTemplateContainer taskTemplateContainer, TaskTemplateRoleContainer taskTemplateRoleContainer)
        {
            this.User = user;
        ...
        public void FilterTaskTemplateViewModelList(TaskTemplateContainer taskTemplateContainer, MakandraProcessContainer makandraProcessContainer, UserRolesContainer userRolesContainer, TaskTemplateRoleContainer taskTemplateRoleContainer) {
            ...
            if (ProcessId == 0) {
                ...
                taskTemplates = taskTemplateContainer.GetTaskTemplatesArchivedWithProcessId(ProcessId).Result;
            }
        ...
        /// <summary>
        /// Sort the list of archived <see cref="TaskTemplate"/>s  new after the search-attribute
        /// </summary>
        /// <author>Matthias Grafberger</author>
