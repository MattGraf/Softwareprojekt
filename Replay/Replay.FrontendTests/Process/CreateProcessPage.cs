...
namespace Replay.FrontendTests.Process
{
    public class CreateProcessPage
    {
        ...
        private const string URI = "https://localhost:7102/MakandraProcess/Create";
        ...
        public CreateProcessPage(IWebDriver driver) => _driver = driver;
        ...
        public void PopulateDescriptor(string name) => Descriptor.SendKeys(name);
